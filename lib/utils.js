...
// ============================================
// DATE FORMATTING (WIB/Indonesian Timezone)
// ============================================
...
// Format to ISO string in WIB
export const toWIBISOString = (date = new Date()) => {
  return toWIB(date).toISOString()
}
...
export const formatDate = (date) => {
  ...
  try {
    ...
    return format(wibDate, DATE_FORMAT, { locale: id })
  } catch {
    return '-'
  }
}
...
export const formatDateIndonesian = (date) => {
  ...
  try {
    const wibDate = toWIB(date)
    return format(wibDate, 'EEEE, dd MMMM yyyy', { locale: id })
  } catch {
    return '-'
  }
}
...
export const formatTime = (date) => {
  ...
  try {
    const wibDate = toWIB(date)
    return format(wibDate, TIME_FORMAT, { locale: id })
  } catch {
    return '-'
  }
}
...
export const formatDateTime = (date) => {
  ...
  try {
    const wibDate = toWIB(date)
    return format(wibDate, DATETIME_FORMAT, { locale: id })
  } catch {
    return '-'
  }
}
